/*
 * Internal header for the CGPackageManager extension.
 *
...
#ifndef CGPACKAGEMANAGER_INTERNAL_H
#define CGPACKAGEMANAGER_INTERNAL_H
...
#endif /* !CGPACKAGEMANAGER_INTERNAL_H */